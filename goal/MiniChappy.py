...
def send_message():
    ...
    send_btn.config(text="問い合わせ中...", state=tk.DISABLED, bg="#ffb347")
    ...
    send_btn.config(text="送信", state=tk.NORMAL, bg="#87CEFA")
...
# チャットの履歴を表示するテキストエリア
chat_box = tk.Text(root, width=50, height=15, font=cf, bg="#f0f8ff")
...
# メッセージを入力する入力欄
entry = tk.Entry(frame, font=cf, bg="#ffffe0")
entry.pack(side=tk.LEFT, fill=tk.X, expand=True, padx=(0, 10))

# 送信ボタン
send_btn = tk.Button(frame, text="送信", font=cf, bg="#87CEFA", command=send_message, width=12)
